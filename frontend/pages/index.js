...
export async function getServerSideProps(){
  ...
  const [res,res2,res3]=await Promise.all([fetch(`http://localhost:8000/api/CryptoTop3`),
  ...
  const [homeCard,yfInfo,yfStats]= await Promise.all([res.json(),res2.json(),res3.json()]) 
  ...
  return { props: { homeCard , yfInfo,yfStats} }
}
